...
function ViewContextProvider({ children }: { children: ReactNode }) {
    ...
    const [viewIcons] = useState({
        [VIEWS.FILES]: sidebarIcons.fileIcon,
        [VIEWS.CLIENTS]: sidebarIcons.userIcon,
        // [VIEWS.SETTINGS]: sidebarIcons.settingIcon,
        [VIEWS.CHATS]: sidebarIcons.chatIcon,
        [VIEWS.RUN]: sidebarIcons.playIcon,
    })
